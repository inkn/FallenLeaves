...
function initModel() {
    ...
    var ground = new THREE.Mesh(new THREE.PlaneBufferGeometry(2000, 2000), new THREE.MeshStandardMaterial({color:0xaaaaaa}));
    ground.position.y = 0;
    ...
    fbx_loader.load('./models/tree/Klenold.fbx', function (object) {
    ...
    fbx_loader.load('./models/stone/stone_heap1.fbx', function (object) {
