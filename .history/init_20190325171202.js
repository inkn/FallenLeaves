...
function initRenderer() {
    ...
    document.getElementById('plugins').appendChild(renderer.domElement)
}
...
function initModel() {
    ...
    fbx_loader.load('./models/tree3/tree.fbx', function (object) {
        ...
        object.children[0].marterial.side = THREE.DoubleSide
        object.children[1].marterial.side = THREE.DoubleSide
        object.children[2].marterial.side = THREE.DoubleSide
        scene.add(object);
        console.log(object)
    });
