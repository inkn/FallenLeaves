...
function initDatGui() {
    ...
    // datGui.add(args, 'cameraX', -1500, 1500)
    // datGui.add(args, 'cameraY', -1500, 1500)
    // datGui.add(args, 'cameraZ', -1500, 1500)
}
...
function initLeaves() {
    ...
    // // 加载雨滴纹理贴图
    // var textureTree = new THREE.TextureLoader().load("./textures/leaves/Leafs2.png");
    // // 创建一个组表示所有的雨滴
