...
(function () {
    ...
    Object.assign(THREE.FBXLoader.prototype, {
        ...
        parse: function (FBXBuffer, resourceDirectory) {
            ...
            var textures = parseTextures(FBXTree, new THREE.TextureLoader(this.manager).setPath(
                resourceDirectory), images, connections);
        ...
        if ('Video' in FBXTree.Objects) {
            ...
            for (var nodeID in videoNodes) {
                ...
                if ('Content' in videoNode) {
                    ...
                    var arrayBufferContent = (videoNode.Content instanceof ArrayBuffer) && (videoNode.Content.byteLength >
                        0);
    ...
    function parseParameters(FBXTree, properties, textureMap, ID, connections) {
        ...
        connections.get(ID).children.forEach(function (child) {
            ...
            switch (type) {
                ...
                default:
                    console.warn('THREE.FBXLoader: %s map is not supported in three.js, skipping texture.',
                        type);
                    break;
        ...
        if ('Deformer' in FBXTree.Objects) {
            ...
            for (var nodeID in DeformerNodes) {
                ...
                if (deformerNode.attrType === 'Skin') {
                    ...
                    if (relationships.parents.length > 1) console.warn(
            ...
            if (skeleton) {
                ...
                if (weights.length > 4) {
                    ...
                    weights.forEach(function (weight, weightIndex) {
                        ...
                        Weight.forEach(function (comparedWeight, comparedWeightIndex,
                            comparedWeightArray) {
    ...
    function parseNurbsGeometry(geometryNode) {
        ...
        if (isNaN(order)) {
            ...
            console.error('THREE.FBXLoader: Invalid Order %s given for geometry ID: %s', geometryNode.Order,
                geometryNode.id);
            return new THREE.BufferGeometry();
    ...
    function createCamera(FBXTree, relationships) {
        ...
        if (cameraAttribute === undefined) {
            ...
            var type = 0;
            if (cameraAttribute.CameraProjectionType !== undefined && cameraAttribute.CameraProjectionType.value ===
                1) {
            ...
            switch (type) {
                ...
                case 1: // Orthographic
                    model = new THREE.OrthographicCamera(-width / 2, width / 2, height / 2, -height / 2,
    ...
    function createLight(FBXTree, relationships) {
        ...
        if (lightAttribute === undefined) {
            ...
            if (lightAttribute.FarAttenuationEnd !== undefined) {
                ...
                if (lightAttribute.EnableFarAttenuation !== undefined && lightAttribute.EnableFarAttenuation.value ===
                    0) {
            ...
            switch (type) {
                ...
                default:
                    console.warn('THREE.FBXLoader: Unknown light type ' + lightAttribute.LightType.value +
                ...
                if (geometryMap.has(parent.ID)) {
                    ...
                    geoRelationships.parents.forEach(function (geoConnParent) {
                        ...
                        if (modelMap.has(geoConnParent.ID)) {
                            ...
                            model.bind(new THREE.Skeleton(skeleton.bones), bindMatrices[
                                geoConnParent.ID]);
            ...
            if (connection !== undefined) {
                ...
                children.forEach(function (child, i) {
                    ...
                    if (curveNodesMap.has(child.ID)) {
                        ...
                        if (curveNode.curves.x !== undefined || curveNode.curves.y !== undefined ||
                            ...
                            if (layerCurveNodes[i] === undefined) {
                                ...
                                if ('Lcl_Translation' in rawModel) node.initialPosition = rawModel.Lcl_Translation
                                    .value;

                                if ('Lcl_Rotation' in rawModel) node.initialRotation = rawModel.Lcl_Rotation
                                    .value;
    ...
    function generateTracks(rawTracks) {
        ...
        if (rawTracks.T !== undefined && Object.keys(rawTracks.T.curves).length > 0) {
            ...
            var positionTrack = generateVectorTrack(rawTracks.modelName, rawTracks.T.curves, rawTracks.initialPosition,
                'position');
        ...
        if (rawTracks.R !== undefined && Object.keys(rawTracks.R.curves).length > 0) {
            ...
            var rotationTrack = generateRotationTrack(rawTracks.modelName, rawTracks.R.curves, rawTracks.initialRotation,
                rawTracks.preRotations);
        ...
        if (rawTracks.S !== undefined && Object.keys(rawTracks.S.curves).length > 0) {
            ...
            var scaleTrack = generateVectorTrack(rawTracks.modelName, rawTracks.S.curves, rawTracks.initialScale,
                'scale');
        ...
        parse: function (text) {
            ...
            split.forEach(function (line, i) {
                ...
                var matchBeginning = line.match('^\\t{' + self.currentIndent + '}(\\w+):(.*){',
                    '');
                var matchProperty = line.match('^\\t{' + (self.currentIndent) +
                    '}(\\w+):[\\s\\t\\r\\n](.*)');
    ...
    Object.assign(BinaryParser.prototype, {
        ...
        parseNode: function (reader, version) {
            ...
            node.singleProperty = (numProperties === 1 && reader.getOffset() === endOffset) ? true :
                false;
        ...
        parseSubNode: function (name, node, subNode) {
            ...
            if (subNode.singleProperty === true) {
                ...
                if (innerPropName.indexOf('Lcl ') === 0) innerPropName = innerPropName.replace('Lcl ',
                    'Lcl_');
                if (innerPropType1.indexOf('Lcl ') === 0) innerPropType1 = innerPropType1.replace(
                    'Lcl ', 'Lcl_');

                if (innerPropType1 === 'Color' || innerPropType1 === 'ColorRGB' || innerPropType1 ===
                    'Vector' || innerPropType1 === 'Vector3D' || innerPropType1.indexOf('Lcl_') === 0) {
